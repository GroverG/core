  ...
  $scope.team_promise.then(function (team) {
    ...
    $scope.team_taggings = {
      add: function(child_tag) {
        Tag.create({ team_add_child: child_tag, parent_id: team.id, parent_type: 'Team', child_id: child_tag.id, child_text: child_tag.name}, function(response) {
      ...
      remove: function(child_tag) {
        Tag.create({ team_remove_child: child_tag, parent_id: team.id, parent_type: 'Team', child_id: child_tag.id, child_text: child_tag.name}, function(response) {
          $scope.team_taggings.model = null;
          $scope.team_taggings.refresh();
        });
      },
